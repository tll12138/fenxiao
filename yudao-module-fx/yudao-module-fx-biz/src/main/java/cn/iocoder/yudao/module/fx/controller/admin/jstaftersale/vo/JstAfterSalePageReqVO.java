...
@Schema(description = "管理后台 - 分销退货传聚水潭中间分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class JstAfterSalePageReqVO extends PageParam {
    ...
    @Schema(description = "标记数据来源，值为 2b 或 2c，对应传聚水潭的接口", example = "2")
