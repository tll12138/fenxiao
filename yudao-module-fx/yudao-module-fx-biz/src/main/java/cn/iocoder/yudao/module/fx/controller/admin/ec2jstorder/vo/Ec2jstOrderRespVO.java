...
@Schema(description = "管理后台 - 分销订单上传中间 Response VO")
@Data
@ExcelIgnoreUnannotated
public class Ec2jstOrderRespVO {
    ...
    @ExcelProperty("订单异常描述")
    private String questionDesc;

    @Schema(description = "卖家标签（旗帜）")
    @ExcelProperty("卖家标签（旗帜）")
    ...
    @ExcelProperty("调入仓公司内仓库id，主仓=1，销退仓=2，进货仓=3，次品仓=4，自定义1仓=6，自定义2仓=7，自定义3仓=8（对应ERP仓库资料设定页面）")
    ...
    @ExcelProperty("调出仓公司内仓库id，主仓=1，销退仓=2，进货仓=3，次品仓=4，自定义1仓=6，自定义2仓=7，自定义3仓=8（对应ERP仓库资料设定页面）")
    private String warehouseId;

    @Schema(description = "内部调拨单号ID", example = "17184")
    @ExcelProperty("内部调拨单号ID")
    private String allocateInId;

    @Schema(description = "是否出库 1已出库，0没有，2出库失败")
    @ExcelProperty("是否出库 1已出库，0没有，2出库失败")
